                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    // Fetch admin users
                                    $sql = "SELECT User_Id, First_Name, Last_Name, Username, Role, Create_At FROM tbl_user WHERE Role = 'Admin'";
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addAdminForm" action="connection/add_admin.php" method="post">
