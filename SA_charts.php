...
// Only allow 'System Admin' role to access this page
...
<body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="staff.php">Welcome, System Admin!</a>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="SA_history.php">
                            ...
                            <a class="nav-link" href="SA_charts.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                                Charts
                            </a>
                            ...
                            <a class="nav-link" href="SA_report.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                                Generate Report
                            </a>
