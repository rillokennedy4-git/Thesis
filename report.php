...
<div class="col-md-2 mb-3">
    ...
    $('#printButton').on('click', function () {
        ...
        $(this).attr('href', `print.php?yearValue=${yearValue}&semesterValue=${semesterValue}&programValue=${programValue}&statusValue=${statusValue}&genderValue=${genderValue}&recordStatusValue=${recordStatusValue}`);
    });
</script>
    <script>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    $('#printButton').on('click', function (e) {
        ...
        // Redirect to print.php with filter parameters
        window.location.href = `print.php?yearValue=${filters.yearValue}&semesterValue=${filters.semesterValue}&programValue=${filters.programValue}&statusValue=${filters.statusValue}&genderValue=${filters.genderValue}&recordStatusValue=${filters.recordStatusValue}`;
    });
