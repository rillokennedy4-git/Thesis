                ...
                <div class="col-md-4 text-center">
                    <div>
                        <img id="profilePicturePreview" 
                                ...
                                <label for="profilePictureInput" class="btn btn-primary mt-2">
    <i class="fas fa-camera"></i> 
</label>
<input type="file" id="profilePictureInput" name="picture" class="d-none" accept="image/*" onchange="previewProfilePicture(event)">
                        <button type="button" class="btn btn-primary mt-2" onclick="updateProfilePicture()">Update Picture</button>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control" id="firstName" name="firstName" 
                            ...
                            onblur="restoreDefaultText(this, '<?php echo htmlspecialchars($user['First_Name']); ?>')">
                        <button type="button" class="btn btn-primary mt-2" onclick="updateField('firstName', 'First Name')">Update First Name</button>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="lastName" name="lastName" 
                            ...
                            onfocus="clearDefaultText(this)" 
                            onblur="restoreDefaultText(this, '<?php echo htmlspecialchars($user['Last_Name']); ?>')">
                        <button type="button" class="btn btn-primary mt-2" onclick="updateField('lastName', 'Last Name')">Update Last Name</button>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="username" name="username" 
                            ...
                            onfocus="clearDefaultText(this)" 
                            onblur="restoreDefaultText(this, '<?php echo htmlspecialchars($user['Username']); ?>')">
                        <button type="button" class="btn btn-primary mt-2" onclick="updateField('username', 'Username')">Update Username</button>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="confirmPassword" name="confirmPassword" 
                            ...
                            onfocus="clearDefaultText(this)" 
                            onblur="restoreDefaultText(this, '')">
                        <button type="button" class="btn btn-primary mt-2" onclick="updatePassword()">Update Password</button>
                    </div>
