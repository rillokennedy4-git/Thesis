...
<body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <?php include 'SA_addingexcel.php'; ?>
                </div>
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-body">
                                    <form method="POST" id="studentForm" action="SA_addingofstudents.php" onsubmit="return validateFormAndConfirm();">
    ...
    // Function to validate name fields to only contain letters, spaces, and periods
    function validateName(input) {
        var pattern = /^[a-zA-Z\s.]*$/; // Allow letters, spaces, and periods
        if (!pattern.test(input.value)) {
            input.setCustomValidity('Please enter a valid name (letters, spaces, and periods only).');
